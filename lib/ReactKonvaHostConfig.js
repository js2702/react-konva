...
const ReactKonvaCore_1 = require("./ReactKonvaCore");
const NO_CONTEXT = {};
const UPDATE_SIGNAL = {};
...
function createInstance(type, props, internalInstanceHandle) {
    ...
    for (var key in props) {
        if (key === ReactKonvaCore_1.Primitive)
            continue;
    ...
    let instance;
    if (type === ReactKonvaCore_1.Primitive) {
        if (props.object === undefined)
            throw new Error("react-konva: Primitives without 'object' are invalid!");
